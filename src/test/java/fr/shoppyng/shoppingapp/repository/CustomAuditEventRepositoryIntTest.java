...
import fr.shoppyng.shoppingapp.config.audit.AuditEventConverter;
import fr.shoppyng.shoppingapp.domain.PersistentAuditEvent;
...
import static fr.shoppyng.shoppingapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

package fr.shoppyng.shoppingapp.config;
...
import fr.shoppyng.shoppingapp.security.jwt.JWTConfigurer;
import fr.shoppyng.shoppingapp.security.jwt.TokenProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.addFilterBefore(corsFilter,
				...
				.antMatchers("/api/products").permitAll().antMatchers("/api/**")
				...
				.hasAuthority(AuthoritiesConstants.ADMIN).and()
